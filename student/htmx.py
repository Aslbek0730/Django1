...
class HTMXstudentListView(generic.ListView):
...
class HTMXstudentCreateView(generic.CreateView):
    model = models.student
    form_class = forms.studentForm
...
class HTMXstudentDeleteView(generic.DeleteView):
    model = models.student
    success_url = reverse_lazy("student_student_htmx_list")
