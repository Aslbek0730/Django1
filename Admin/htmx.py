...
class HTMXAdminListView(generic.ListView):
    model = models.Admin
...
class HTMXAdminCreateView(generic.CreateView):
    model = models.Admin
    form_class = forms.AdminForm
...
class HTMXAdminDeleteView(generic.DeleteView):
    model = models.Admin
    success_url = reverse_lazy("Admin_Admin_htmx_list")
